...
const heatmapTooltipMonthFmt = new Intl.DateTimeFormat("tr-TR", {
  month: "long",
});

const heatmapTooltipWeekdayFmt = new Intl.DateTimeFormat("tr-TR", {
  weekday: "long",
});
...
// Localised for this app. The registry ships English labels and en-US
// formatters; every other date surface in the panel is Turkish, so a
// GitHub-style calendar labelled Sun/Mon would be the only one that isn't.
