 ...
 * packages like .pptx, which PowerPoint accepts uncompressed. No dependency,
...
export function buildZip(entries: ZipEntry[], now = new Date()): Uint8Array<ArrayBuffer> {
  ...
  // Explicit ArrayBuffer so the result types as Uint8Array<ArrayBuffer> (a valid BlobPart).
